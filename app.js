...
function translateToPersian() {
    ...
    var a = document.getElementById('hm1')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'تکالیف'

    var a = document.getElementById('final1')
    a.style.fontFamily = 'IRANSans'
    ...
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'نام و نام حانوادگی'

    var a = document.getElementById('778')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'نقش'

    var a = document.getElementById('t1')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'دکتر صادق اسکندری'
    ...
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'کیان رضایی'

    var a = document.getElementById('rolet2')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'مسئول کمک مدرسین'

    var a = document.getElementById('t3')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'امیر اصغری'

    var a = document.getElementById('rolet3')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'کمک مدرس'

    var a = document.getElementById('t4')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'عرفان محرم زاده'
    ...
    var a = document.getElementById('notes_hm')
    a.style.fontFamily = 'IRANSans'
    a.style.direction = "rtl"
    ...
    var a = document.getElementById('995')
    a.innerText = 'شماره'
    a.style.fontFamily = 'IRANSans'

    var a = document.getElementById('996')
    a.innerText = 'فایل ها'
    a.style.fontFamily = 'IRANSans'

    var a = document.getElementById('997')
    a.innerText = 'تاریخ تحویل'
    a.style.fontFamily = 'IRANSans'

    var a = document.getElementById('998')
    a.innerText = 'نمرات'
    a.style.fontFamily = 'IRANSans'
    ...
    var a = document.getElementById('notesfinal')
    a.innerText = 'نکات'
    a.style.fontFamily = 'IRANSans'
    a.style.textAlign = 'right'

    var a = document.getElementById('notes_final')
    a.style.direction = "rtl"
...
function translateToEnglish() {
    ...
    a.classList.remove('persian')
    a.style.fontFamily = "Sans-serif"
    a.innerHTML = 'Advance Programming 2022 / Spring semester'
    var a = document.getElementById('subtitle')
    a.classList.remove('persian')
    a.style.fontFamily = "Sans-serif"
    ...
    var a = document.getElementById('3')
      ...
      For more information visit the <a class="link"
        href="#syllabus">Syllabus</a> section.`
    var a = document.getElementById('intro')
    a.classList.remove('persian')
    a.style.fontFamily = "Sans-serif"
    ...
    var a = document.getElementById('t1')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'Dr.Sadegh Eskandari'
    ...
    var a = document.getElementById('t4')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'Erfan Moharamzadeh'
    ...
    var a = document.getElementById('t6')
    a.style.fontFamily = 'IRANSans'
    a.innerHTML = 'Amirhossein Rahimi'
    ...
    var s = document.getElementsByTagName('th');
    for (i = 0; i < s.length; i++) {
        s[i].style.fontFamily = 'Sans-serif';
    }
